    ...
    if (HARDWARE == 1) begin : rom_hardware
      ...
      always_ff @(posedge clock) begin
        case (raddr)
          ...
          6'b100000: rdata <= 32'h2023000F;
          6'b100001: rdata <= 32'h0F13000F;
          6'b100010: rdata <= 32'h0D630FF0;
          6'b100011: rdata <= 32'h0F3701FF;
          6'b100100: rdata <= 32'h0F210100;
          6'b100101: rdata <= 32'h000F2F83;
          6'b100110: rdata <= 32'h000F2023;
          6'b100111: rdata <= 32'h0FF00F13;
          6'b101000: rdata <= 32'h30200073;
          6'b101001: rdata <= 32'h00028E83;
          6'b101010: rdata <= 32'h01D30023;
          6'b101011: rdata <= 32'h03850305;
          6'b101100: rdata <= 32'h01C3D463;
          6'b101101: rdata <= 32'h30200073;
          6'b101110: rdata <= 32'h800000B7;
          6'b101111: rdata <= 32'h00008067;
